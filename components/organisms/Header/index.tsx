...
export const Header = (props: HeaderProps) => {
  ...
  const onClickSolutions = () => setShowSolutions(!showSolutions);
  const onClickMore = () => setShowMore(!showMore);
        ...
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <nav className="hidden md:flex space-x-10">
            <div className="relative">
              ...
              <button onClick={onClickSolutions} type="button" className="text-gray-500 group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" aria-expanded="false">
                <span>Solutions</span>
                {/* <!--
              ...
              --> */}
              <div className={`transition ease-out duration-700 ${showSolutions ? "opacity-100 visible" : "opacity-0 hidden"} absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2`}>
            ...
            <Link href="/"><a className="text-base font-medium text-gray-500 hover:text-gray-900">Home</a></Link>
            <Link href="/setting"><a className="text-base font-medium text-gray-500 hover:text-gray-900">Setting</a></Link>
            <Link href="/profile"><a className="text-base font-medium text-gray-500 hover:text-gray-900">Profile</a></Link>

            <div className="relative">
              {/* <!-- Item active: "text-gray-900", Item inactive: "text-gray-500" --> */}
              <button onClick={onClickMore} type="button" className="text-gray-500 group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" aria-expanded="false">
                <span>More</span>
                {/* <!--
                  Heroicon name: solid/chevron-down
              ...
              {/* <!--
                ...
                Leaving: "transition ease-in duration-150"
                  ...
                  To: "opacity-0 translate-y-1"
              --> */}
              <div className={`transition ease-out duration-700 ${showMore ? "opacity-100 visible" : "opacity-0 hidden"} absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0`}>
                <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                  <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                    <a className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                    ...
                    <div>
                      ...
                      <ul role="list" className="mt-4 space-y-4">
                        <li className="text-base truncate">
                          <a className="font-medium text-gray-900 hover:text-gray-700"> Boost your conversion rate </a>
                        </li>

                        <li className="text-base truncate">
                          <a className="font-medium text-gray-900 hover:text-gray-700"> How to use search engine optimization to drive traffic to your site </a>
                        </li>

                        <li className="text-base truncate">
                          <a className="font-medium text-gray-900 hover:text-gray-700"> Improve your customer experience </a>
                        </li>
                      </ul>
                    </div>
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            ...
            {
              props.session ?
              <button aria-label='signout' onClick={props.onSignOut} className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> Sign out </button>
              :
              <button aria-label='signin' onClick={props.onSignIn} className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> Sign in </button>
            }
          </div>
        </div>
      </div>
        ...
        <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
          ...
          <div className="py-6 px-5 space-y-6">
            <div className="grid grid-cols-2 gap-y-4 gap-x-8">
              ...
              <a className="text-base font-medium text-gray-900 hover:text-gray-700"> Help Center </a>

              <a className="text-base font-medium text-gray-900 hover:text-gray-700"> Guides </a>

              <a className="text-base font-medium text-gray-900 hover:text-gray-700"> Events </a>

              <a className="text-base font-medium text-gray-900 hover:text-gray-700"> Security </a>
            </div>
            <div>
              <a className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> Sign up </a>
